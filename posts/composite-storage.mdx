...
import 3d-scan. from '../src/images/composite-storage/3d-scan.png';
import breather from '../src/images/composite-storage/breather.jpg';
import inside from '../src/images/composite-storage/inside.jpg';
import insidebox from '../src/images/composite-storage/insidebox.jpg';
import mounted from '../src/images/composite-storage/mounted.jpg';
import open from '../src/images/composite-storage/open.jpg';
import render from '../src/images/composite-storage/render.png';
import split from '../src/images/composite-storage/split.jpg';
import suction from '../src/images/composite-storage/suction.jpg';
...
<Image src={3d-scan} alt="3d-scan" sizes="50vw" style="width: 50%; height: auto;" />
<Image src={insidebox} alt="insidebox" sizes="50vw" style="width: 50%; height: auto;" />
...
<Image src={render} alt="render" sizes="50vw" style="width: 50%; height: auto;" />
...
![Split mould](/composite-storage/split.jpg)
<Image src={inside} alt="inside" sizes="50vw" style="width: 50%; height: auto;" />
<Image src={suction} alt="suction" sizes="50vw" style="width: 50%; height: auto;" />
...
<Image src={open} alt="open" sizes="50vw" style="width: 50%; height: auto;" />
<Image src={mounted} alt="mounted" sizes="50vw" style="width: 50%; height: auto;" />
